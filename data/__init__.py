...
replaced_train_positive_location = '../data/twitter-datasets/replaced_train_pos_full.txt'
replaced_train_negative_location = '../data/twitter-datasets/replaced_train_neg_full.txt'
