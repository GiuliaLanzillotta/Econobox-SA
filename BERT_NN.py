...
class PP_BERT_Data():
    ...
    def __init__(self, data_input, classes, max_seq_len, prediction_mode):
        ...
        if self.prediction_mode:
            ...
            print("max seq_length", self.max_seq_len)
...
class BERT_NN(BaseNN):
    ...
    def build(self, bert_ckpt_file=bert_ckpt_file_location, **kwargs):
        ...
        input_ids = tf.keras.layers.Input(shape=(self.max_seq_len,), dtype='int32', name="input_ids")
